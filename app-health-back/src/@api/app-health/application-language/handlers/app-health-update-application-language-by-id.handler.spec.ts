...
describe('AppHealthUpdateApplicationLanguageByIdHandler', () =>
{
    ...
    describe('main', () =>
    {
        ...
        test('should return a applicationLanguage updated', async () =>
        {
            ...
            expect(await handler.main(<AppHealthUpdateApplicationLanguageByIdInput>appHealthMockApplicationLanguageData[0])).toBe(appHealthMockApplicationLanguageData[0]);
        });
    });
});
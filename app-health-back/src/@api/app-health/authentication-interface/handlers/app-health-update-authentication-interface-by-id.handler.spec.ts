...
describe('AppHealthUpdateAuthenticationInterfaceByIdHandler', () =>
{
    ...
    describe('main', () =>
    {
        ...
        test('should return a authenticationInterface updated', async () =>
        {
            ...
            expect(await handler.main(<AppHealthUpdateAuthenticationInterfaceByIdInput>appHealthMockAuthenticationInterfaceData[0])).toBe(appHealthMockAuthenticationInterfaceData[0]);
        });
    });
});
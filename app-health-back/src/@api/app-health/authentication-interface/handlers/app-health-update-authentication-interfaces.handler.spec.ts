...
describe('AppHealthUpdateAuthenticationInterfacesHandler', () =>
{
    ...
    describe('main', () =>
    {
        ...
        test('should return a authenticationInterfaces updated', async () =>
        {
            ...
            expect(await handler.main(<AppHealthUpdateAuthenticationInterfacesInput>appHealthMockAuthenticationInterfaceData[0])).toBe(appHealthMockAuthenticationInterfaceData[0]);
        });
    });
});
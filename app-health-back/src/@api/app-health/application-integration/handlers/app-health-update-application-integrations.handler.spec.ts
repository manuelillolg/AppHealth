...
describe('AppHealthUpdateApplicationIntegrationsHandler', () =>
{
    ...
    describe('main', () =>
    {
        ...
        test('should return a applicationIntegrations updated', async () =>
        {
            ...
            expect(await handler.main(<AppHealthUpdateApplicationIntegrationsInput>appHealthMockApplicationIntegrationData[0])).toBe(appHealthMockApplicationIntegrationData[0]);
        });
    });
});
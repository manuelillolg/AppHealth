...
describe('AppHealthUpdateAuthorizationInterfacesHandler', () =>
{
    ...
    describe('main', () =>
    {
        ...
        test('should return a authorizationInterfaces updated', async () =>
        {
            ...
            expect(await handler.main(<AppHealthUpdateAuthorizationInterfacesInput>appHealthMockAuthorizationInterfaceData[0])).toBe(appHealthMockAuthorizationInterfaceData[0]);
        });
    });
});
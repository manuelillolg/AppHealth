...
export interface AppHealthUpdateInfrastuctureProvidersInput {
    id?: Nullable<string>;
    name?: Nullable<GraphQLString>;
    score?: Nullable<GraphQLInt>;
}
...
export interface IQuery {
    ...
    appHealthGetInfrastuctureProviders(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<AppHealthInfrastructureProvider>[] | Promise<Nullable<AppHealthInfrastructureProvider>[]>;
    appHealthPaginateInfrastuctureProviders(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Pagination | Promise<Pagination>;
...
export interface IMutation {
    ...
    appHealthCreateInfrastuctureProviders(payload: Nullable<AppHealthCreateInfrastructureProviderInput>[]): boolean | Promise<boolean>;
    ...
    appHealthUpdateInfrastuctureProviders(payload: AppHealthUpdateInfrastuctureProvidersInput, query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<AppHealthInfrastructureProvider>[] | Promise<Nullable<AppHealthInfrastructureProvider>[]>;
    ...
    appHealthDeleteInfrastuctureProviders(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<AppHealthInfrastructureProvider>[] | Promise<Nullable<AppHealthInfrastructureProvider>[]>;

...
describe('AppHealthUpsertLanguageService', () =>

{
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(AppHealthUpsertLanguageService);
    ...
    describe('main', () =>
    {
        test('AppHealthUpsertLanguageService should be defined', () =>
        {
            expect(service).toBeDefined();
        });

        test('should upsert a language and emit event', async () =>
        {

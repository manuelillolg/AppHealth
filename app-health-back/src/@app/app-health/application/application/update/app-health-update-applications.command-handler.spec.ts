                ...
                new AppHealthUpdateApplicationsCommand(
                    {
                        ...
                        views: appHealthMockApplicationData[0].views,
                        authentications: appHealthMockApplicationData[0].authentications,
                        authorizations: appHealthMockApplicationData[0].authorizations,
                        languages: appHealthMockApplicationData[0].languages,
                        infrastructureServices: appHealthMockApplicationData[0].infrastructureServices,
                        databases: appHealthMockApplicationData[0].databases,
                        apis: appHealthMockApplicationData[0].apis,
                        integrations: appHealthMockApplicationData[0].integrations,
                    },
                    {},
                    {},

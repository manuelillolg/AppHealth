...
describe('AppHealthPaginateApplicationsService', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(AppHealthPaginateApplicationsService);
    ...
    describe('main', () =>
    {
        test('AppHealthPaginateApplicationsService should be defined', () =>
        {

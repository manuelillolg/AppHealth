...
describe('AppHealthDeleteApplicationsService', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(AppHealthDeleteApplicationsService);
    ...
    describe('main', () =>
    {
        test('AppHealthDeleteApplicationsService should be defined', () =>
        {

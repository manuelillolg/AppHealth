        ...
        for (const application of _.orderBy(appHealthMockApplicationData, ['id']))
        {
            this.collectionSource.push(
                AppHealthApplication.register(
                    ...
                    new AppHealthApplicationViews(application.views),
                    new AppHealthApplicationAuthentications(application.authentications),
                    new AppHealthApplicationAuthorizations(application.authorizations),
                    new AppHealthApplicationLanguages(application.languages),
                    new AppHealthApplicationInfrastructureServices(application.infrastructureServices),
                    new AppHealthApplicationDatabases(application.databases),
                    new AppHealthApplicationApis(application.apis),
                    new AppHealthApplicationIntegrations(application.integrations),

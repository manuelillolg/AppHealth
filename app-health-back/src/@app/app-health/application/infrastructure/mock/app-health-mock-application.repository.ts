    ...
    private createSourceMockData(): void
    {
        ...
        for (const itemCollection of <any[]>appHealthMockApplicationData)
        {
            ...
            this.collectionSource.push(AppHealthApplication.register(
                ...
                new AppHealthApplicationViews(itemCollection.views),
                new AppHealthApplicationAuthentications(itemCollection.authentications),
                new AppHealthApplicationAuthorizations(itemCollection.authorizations),
                new AppHealthApplicationLanguages(itemCollection.languages),
                new AppHealthApplicationInfrastructureServices(itemCollection.infrastructureServices),
                new AppHealthApplicationDatabases(itemCollection.databases),
                new AppHealthApplicationApis(itemCollection.apis),
                new AppHealthApplicationIntegrations(itemCollection.integrations),

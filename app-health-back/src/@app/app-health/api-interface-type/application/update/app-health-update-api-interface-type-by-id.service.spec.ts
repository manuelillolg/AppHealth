...
describe('AppHealthUpdateApiInterfaceTypeByIdService', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(AppHealthUpdateApiInterfaceTypeByIdService);
    ...
    describe('main', () =>
    {
        test('AppHealthUpdateApiInterfaceTypeByIdService should be defined', () =>
        {
            expect(service).toBeDefined();
        });

        test('should update a apiInterfaceType and emit event', async () =>
        {

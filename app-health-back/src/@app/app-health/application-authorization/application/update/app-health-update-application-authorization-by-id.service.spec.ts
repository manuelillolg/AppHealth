...
describe('AppHealthUpdateApplicationAuthorizationByIdService', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(AppHealthUpdateApplicationAuthorizationByIdService);
    ...
    describe('main', () =>
    {
        test('AppHealthUpdateApplicationAuthorizationByIdService should be defined', () =>
        {
            expect(service).toBeDefined();
        });

        test('should update a applicationAuthorization and emit event', async () =>
        {

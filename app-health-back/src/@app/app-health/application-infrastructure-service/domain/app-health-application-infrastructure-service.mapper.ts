...
export class AppHealthApplicationInfrastructureServiceMapper implements IMapper
{
     ...
     * @param applicationInfrastructureServices
     */
    mapModelsToAggregates(applicationInfrastructureServices: LiteralObject[], cQMetadata?: CQMetadata): AppHealthApplicationInfrastructureService[]
    {
        if (!Array.isArray(applicationInfrastructureServices)) return;

        return applicationInfrastructureServices.map(applicationInfrastructureService => this.makeAggregate(applicationInfrastructureService, cQMetadata));
    }
     ...
     * @param applicationInfrastructureServices
     */
    mapAggregatesToResponses(applicationInfrastructureServices: AppHealthApplicationInfrastructureService[]): AppHealthApplicationInfrastructureServiceResponse[]
    {
        if (!Array.isArray(applicationInfrastructureServices)) return;

        return applicationInfrastructureServices.map(applicationInfrastructureService => this.makeResponse(applicationInfrastructureService));
    }

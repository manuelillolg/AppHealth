...
describe('AppHealthGetApplicationInfrastructureServicesService', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(AppHealthGetApplicationInfrastructureServicesService);
    ...
    describe('main', () =>
    {
        test('GetApplicationInfrastructureServicesService should be defined', () =>
        {

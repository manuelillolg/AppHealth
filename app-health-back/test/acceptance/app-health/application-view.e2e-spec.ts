...
describe('application-view', () =>
{
    ...
    test('/REST:POST app-health/application-view/create - Got 400 Conflict, ApplicationViewComplexity has to be a enum option of LOW, MEDIUM, HIGH', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-view/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationViewComplexity has to be any of this options: LOW, MEDIUM, HIGH');
            });
    });

...
describe('infrastructure-provider', () =>
{
    ...
    test('/REST:POST app-health/infrastucture-providers/paginate', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/infrastucture-providers/paginate')
            .set('Accept', 'application/json')
            .send({
                query:
                {
    ...
    test('/REST:POST app-health/infrastucture-providers/get', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/infrastucture-providers/get')
            .set('Accept', 'application/json')
            .expect(200)
            .then(res =>
            {
    ...
    test('/GraphQL appHealthPaginateInfrastuctureProviders', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.data.appHealthPaginateInfrastuctureProviders).toEqual({
                    total: infrastructureProviderSeeder.collectionResponse.length,
                    count: infrastructureProviderSeeder.collectionResponse.length,
                    rows : infrastructureProviderSeeder.collectionResponse.map(item => expect.objectContaining(_.omit(item, ['createdAt', 'updatedAt', 'deletedAt']))).slice(0, 5),
                });
    ...
    test('/GraphQL appHealthGetInfrastuctureProviders', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                for (const [index, value] of res.body.data.appHealthGetInfrastuctureProviders.entries())
                {
    ...
    test('/GraphQL appHealthUpdateInfrastuctureProviders', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            .send({
                query: `
                    mutation ($payload:AppHealthUpdateInfrastuctureProvidersInput! $query: QueryStatement)
                    {
                        appHealthUpdateInfrastuctureProviders (payload:$payload query:$query)
                        {
                            id
                            name
                            score
            ...
            .then(res =>
            {
                expect(res.body.data.appHealthUpdateInfrastuctureProviders[0].id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });

...
describe('application-authorization', () =>
{
    ...
    test('/REST:POST app-health/application-authorization/create - Got 400 Conflict, ApplicationAuthorizationTotalUsers property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-authorization/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationAuthorizationTotalUsers must be defined, can not be null');
            });
    });
    ...
    test('/REST:POST app-health/application-authorization/create - Got 400 Conflict, ApplicationAuthorizationTotalUsers property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-authorization/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationAuthorizationTotalUsers must be defined, can not be undefined');
            });
    });

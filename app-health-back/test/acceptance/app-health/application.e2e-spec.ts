...
describe('application', () =>
{
    ...
    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationReleaseDate property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationReleaseDate must be defined, can not be null');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationArchitectureDiagram property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationArchitectureDiagram must be defined, can not be null');
            });
    });
    ...
    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationCostLicensesPerYear property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                costLicensesPerYear: null,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationCostLicensesPerYear must be defined, can not be null');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationRequestsPerDay property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationRequestsPerDay must be defined, can not be null');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationViews property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationViews must be defined, can not be null');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationAuthentications property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationAuthentications must be defined, can not be null');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationAuthorizations property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationAuthorizations must be defined, can not be null');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationLanguages property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationLanguages must be defined, can not be null');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationInfrastructureServices property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationInfrastructureServices must be defined, can not be null');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationDatabases property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationDatabases must be defined, can not be null');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationApis property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationApis must be defined, can not be null');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationIntegrations property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationIntegrations must be defined, can not be null');
            });
    });
    ...
    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationReleaseDate property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationReleaseDate must be defined, can not be undefined');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationArchitectureDiagram property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationArchitectureDiagram must be defined, can not be undefined');
            });
    });
    ...
    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationCostLicensesPerYear property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                costLicensesPerYear: undefined,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationCostLicensesPerYear must be defined, can not be undefined');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationRequestsPerDay property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationRequestsPerDay must be defined, can not be undefined');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationViews property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationViews must be defined, can not be undefined');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationAuthentications property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationAuthentications must be defined, can not be undefined');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationAuthorizations property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationAuthorizations must be defined, can not be undefined');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationLanguages property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationLanguages must be defined, can not be undefined');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationInfrastructureServices property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                infrastructureServices: undefined,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationInfrastructureServices must be defined, can not be undefined');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationDatabases property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationDatabases must be defined, can not be undefined');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationApis property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationApis must be defined, can not be undefined');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationIntegrations property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationIntegrations must be defined, can not be undefined');
            });
    });
    ...
    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationViews is not allowed, must be a length of 36', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationViews is not allowed, must be a length of 36');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationAuthentications is not allowed, must be a length of 36', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationAuthentications is not allowed, must be a length of 36');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationAuthorizations is not allowed, must be a length of 36', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationAuthorizations is not allowed, must be a length of 36');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationLanguages is not allowed, must be a length of 36', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationLanguages is not allowed, must be a length of 36');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationInfrastructureServices is not allowed, must be a length of 36', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationInfrastructureServices is not allowed, must be a length of 36');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationDatabases is not allowed, must be a length of 36', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationDatabases is not allowed, must be a length of 36');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationApis is not allowed, must be a length of 36', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationApis is not allowed, must be a length of 36');
            });
    });

    test('/REST:POST app-health/application/create - Got 400 Conflict, ApplicationIntegrations is not allowed, must be a length of 36', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationIntegrations is not allowed, must be a length of 36');
            });
    });

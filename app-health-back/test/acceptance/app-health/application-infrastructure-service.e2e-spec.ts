...
describe('application-infrastructure-service', () =>
{
    ...
    test('/REST:POST app-health/application-infrastructure-services/paginate', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-infrastructure-services/paginate')
            .set('Accept', 'application/json')
            .send({
                query:
                {
    ...
    test('/REST:POST app-health/application-infrastructure-services/get', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-infrastructure-services/get')
            .set('Accept', 'application/json')
            .expect(200)
            .then(res =>
            {
    ...
    test('/GraphQL appHealthPaginateApplicationInfrastructureServices', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.data.appHealthPaginateApplicationInfrastructureServices).toEqual({
                    total: applicationInfrastructureServiceSeeder.collectionResponse.length,
                    count: applicationInfrastructureServiceSeeder.collectionResponse.length,
                    rows : applicationInfrastructureServiceSeeder.collectionResponse.map(item => expect.objectContaining(_.omit(item, ['createdAt', 'updatedAt', 'deletedAt']))).slice(0, 5),
                });
    ...
    test('/GraphQL appHealthGetApplicationInfrastructureServices', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                for (const [index, value] of res.body.data.appHealthGetApplicationInfrastructureServices.entries())
                {
    ...
    test('/GraphQL appHealthUpdateApplicationInfrastructureServices', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            .send({
                query: `
                    mutation ($payload:AppHealthUpdateApplicationInfrastructureServicesInput! $query: QueryStatement)
                    {
                        appHealthUpdateApplicationInfrastructureServices (payload:$payload query:$query)
                        {
                            id
                            averageCostPerYear
                            score
            ...
            .then(res =>
            {
                expect(res.body.data.appHealthUpdateApplicationInfrastructureServices[0].id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });

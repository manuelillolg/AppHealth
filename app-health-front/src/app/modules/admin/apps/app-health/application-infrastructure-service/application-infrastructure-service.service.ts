import { AppHealthApplicationInfrastructureService, AppHealthCreateApplicationInfrastructureService, AppHealthUpdateApplicationInfrastructureServiceById, AppHealthUpdateApplicationInfrastructureServices } from '../app-health.types';
...
export class ApplicationInfrastructureServiceService
{
    ...
    applicationInfrastructureServicesSubject$: BehaviorSubject<AppHealthApplicationInfrastructureService[] | null> = new BehaviorSubject(null);
    ...
    */
    ...
    get applicationInfrastructureServices$(): Observable<AppHealthApplicationInfrastructureService[]>
    {
        return this.applicationInfrastructureServicesSubject$.asObservable();
    }
    ...
    }>
    {
        return this.graphqlService
            ...
            .pipe(
                ...
                tap(data =>
                {
                    this.applicationInfrastructureServicesSubject$.next(data.objects);
                }),
            );
    }
    ...
    update<T>(
        {
            ...
            graphqlStatement?: DocumentNode;
            object?: AppHealthUpdateApplicationInfrastructureServices;
            query?: QueryStatement;
            constraint?: QueryStatement;
            headers?: GraphQLHeaders;
        } = {},
